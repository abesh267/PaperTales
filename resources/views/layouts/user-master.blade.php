...
<head>
    ...
    <title>Paper Tales - User home</title>
    <!-- Favicon icon -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item px-2">
                    <a href="{{route('discount-books')}}" class="nav-link">Buy and Saves</a>
                </li>
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><img src="assets/img/logo.png" title="Paper Tales " width="60" height="60" alt="Paper Tales "></a></h3>
                </div>
            </div>
            <div class="col-md-4">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="footer-text">
            Copyright &copy; Paper Tales. All Rights Reserved. <span id="year"></span>
        </div>
        <div class="social-icon mt-2">
        <span class="mr-2">
          <a href="https://www.facebook.com/papertales1105" class="text-primary"><i class="fab fa-facebook fa-2x"></i></a>
        </span>
            <span class="mr-2">
          <a href="https://www.instagram.com/papertales1105" class="text-secondary"><i class="fab fa-instagram fa-2x"></i></a>
        </span>
    ...
    <p></p>
    <p><b>Contact Us</b></p>
    <p>Call us at: +8801685505242</p>
    <p>Email: papertales.bookstore@gmail.com</p>
    </div>
</footer>
