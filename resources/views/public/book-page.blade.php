        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <a href="{{ URL::current()."?sort=title_asc" }}" class="sort-font">Name - A to Z</a>
                    <a href="{{ URL::current()."?sort=title_desc" }}" class="sort-font">Name - Z to A</a>
                    <a href="{{ URL::current()."?sort=price_asc" }}" class="sort-font">Price - Low to High</a>
                    <a href="{{ URL::current()."?sort=price_asc" }}" class="sort-font">Price - High to Low</a>
                </div>
                <div class="col-md-8">
